...
* Maroulis, S. and Wilensky, U. (2004).  NetLogo HubNet Oil Cartel model.  http://ccl.northwestern.edu/netlogo/models/HubNetOilCartel.  Center for Connected Learning and Computer-Based Modeling, Northwestern Institute on Complex Systems, Northwestern University, Evanston, IL.
