...
* Novak, M. and Wilensky, U. (2007).  NetLogo Connected Chemistry Rusting Reaction model.  http://ccl.northwestern.edu/netlogo/models/ConnectedChemistryRustingReaction.  Center for Connected Learning and Computer-Based Modeling, Northwestern Institute on Complex Systems, Northwestern University, Evanston, IL.
