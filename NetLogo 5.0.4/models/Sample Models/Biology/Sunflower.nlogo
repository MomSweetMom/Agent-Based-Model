...
* Wilensky, U. (2003).  NetLogo Sunflower model.  http://ccl.northwestern.edu/netlogo/models/Sunflower.  Center for Connected Learning and Computer-Based Modeling, Northwestern Institute on Complex Systems, Northwestern University, Evanston, IL.
