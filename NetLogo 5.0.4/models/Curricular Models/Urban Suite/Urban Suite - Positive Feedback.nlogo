...
* Wilensky, U. (2007).  NetLogo Urban Suite - Positive Feedback model.  http://ccl.northwestern.edu/netlogo/models/UrbanSuite-PositiveFeedback.  Center for Connected Learning and Computer-Based Modeling, Northwestern Institute on Complex Systems, Northwestern University, Evanston, IL.
