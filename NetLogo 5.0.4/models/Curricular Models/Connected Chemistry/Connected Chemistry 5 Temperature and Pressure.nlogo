...
* Wilensky, U. (2005).  NetLogo Connected Chemistry 5 Temperature and Pressure model.  http://ccl.northwestern.edu/netlogo/models/ConnectedChemistry5TemperatureandPressure.  Center for Connected Learning and Computer-Based Modeling, Northwestern Institute on Complex Systems, Northwestern University, Evanston, IL.
