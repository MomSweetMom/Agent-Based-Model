...
* Wilensky, U. (1997).  NetLogo GenDrift P local model.  http://ccl.northwestern.edu/netlogo/models/GenDriftPlocal.  Center for Connected Learning and Computer-Based Modeling, Northwestern Institute on Complex Systems, Northwestern University, Evanston, IL.
